    ...
    <view class="user-index">
        <view class="person-info-data-statistic-wrapper">
            <view class="person-info flex-space-between flex-align-center">
                <view class="info flex-align-center">
                    <view class="ma-10-r">
                        <image class="avatar" :src="userInfo.avatarUrl" v-if="userInfo.avatarUrl"></image>
                    ...
                    <view class="no-info-text-wrapper" v-else><button class="getInfo" open-type="getUserInfo" @getuserinfo="getUserInfo">获取头像</button></view>
                </view>
                <view class="goto-wrapper flex-align-center"><uni-icon type="forward" color="white"></uni-icon></view>
            </view>
        ...
        <view class="tool-menu-body">
            <uni-grid :column="3" :show-border="false" :square="false" @change="change">
                <uni-grid-item>
                    <image class="image" src="cloud://production-15c960.7072-production-15c960/icons/vote-icon.png" mode="aspectFill" />
